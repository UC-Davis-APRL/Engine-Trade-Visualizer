...
class engine():
    def __init__(self, ceaObj, OF = None, Pc_atm = None, M_dot = None, Thrust = None):
    ...
    def A_star(self):
        ...
        self.R_bar_Thr = const.R_ideal / self.MolWt_Thr.to('kg / mol')
    ...
    @cached_property
    def A_e(self):
        self.A_e = (self.AeAt * self.A_star) # *unit conversions are cooked
        return self.A_e


end = time.time()
print(f"Engine runtime {end - start} seconds")
